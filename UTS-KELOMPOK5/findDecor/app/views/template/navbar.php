        ...
        <div class="navbar-nav">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <ul class="navbar-nav ml-auto">
                    ...
                    <a class="nav-item btn masuk mt-3 mr-1 font-weight-bold" href="<?= BASE_URL ?>login">Masuk</a>
                    <a class="nav-item btn tombol mt-3 font-weight-bold border" href="<?= BASE_URL ?>daftar">Daftar</a>
